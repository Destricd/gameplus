# Generated by Django 3.2.9 on 2021-11-25 02:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release_date', models.DateField(default=datetime.datetime(2021, 11, 25, 2, 13, 11, 430285, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('public_date', models.DateField(default=datetime.datetime(2021, 11, 25, 2, 13, 11, 432262, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(default=datetime.datetime(2021, 11, 25, 2, 13, 11, 433240, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_date', models.DateField(default=datetime.datetime(2021, 11, 25, 2, 13, 11, 431260, tzinfo=utc))),
                ('end_date', models.DateField(default=datetime.datetime(2021, 11, 25, 2, 13, 11, 431260, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('conclusion_date', models.DateField(default=datetime.datetime(2021, 11, 25, 2, 13, 11, 432262, tzinfo=utc))),
                ('contract_end_date', models.DateField(default=datetime.datetime(2021, 11, 25, 2, 13, 11, 432262, tzinfo=utc))),
